...
本轮v2复查中，用户针对“本地17套 `/tags/1` HTTP 500”明确要求“本地的先不管”。仅该本地问题暂缓，不修后端、不计作当前样式任务的待处理阻断；原始观察保留且不标pass。其他z1–z17已有页面布局检查继续。具体运行记录见 `runs/z-v2-recheck-20260919/scope-steering.json`。
