...
2026-09-19执行升级：现行细则见 [验收v2](TEMPLATE_ACCEPTANCE_STANDARD_V2.md)；全元素布局、逐任务分配、工具优先。本文早期“AI逐页”要求改为工具逐页留证，只有未覆盖/无法判定项进入AI队列。不存在的候选页按确认的维护范围排除，已有页缺证据仍阻断；公司目录边界保持。
