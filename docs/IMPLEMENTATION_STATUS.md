...
2026-09-19最新工具更新：见 [验收v2实施记录](ACCEPTANCE_V2_IMPLEMENTATION.md)。验收标准适配当次分配编号，增加全元素布局与工具优先门禁；AI只处理明确能力缺口/歧义。当前z1–z17的业务修复范围不变。以下早期z1–z21及v1数据均是历史，不能当作v2全量验收已完成。

> 下文 2026-09-18 表格和“只读首轮”数字是当时的历史快照。2026-09-19 已进入 z1–z21 临时修复，当前事实与证据见 [Z_SERIES_REPAIR_20260919.md](Z_SERIES_REPAIR_20260919.md)；不要把旧“未修改业务代码”当作当前状态。
